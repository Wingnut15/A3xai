...
class CfgA3XAISettings {
	...
	airVehicleList[] = {
		{"B_Heli_Light_01_armed_F",3},
		{"B_Heli_Transport_01_F",1},
		{"B_Heli_Transport_03_F",1},
		{"RHS_AH1Z_wd", 3},
		{"RHS_UH60M2", 3},
		{"RHS_Su25SM_CAS_vvs", 1}
	...
	landVehicleList[] = {
		...
		{"rhsusf_M1078A1P2_d_open_fmtv_usarmy",5},
		{"rhsusf_M1084A1P2_WD_fmtv_usarmy",5},
		{"rhsusf_m998_d_s_4dr",5},	
		{"rhsusf_M1084A1P2_B_WD_fmtv_usarmy",5},
		{"C_Offroad_02_unarmed_F",5},
		{"I_C_Offroad_02_unarmed_F",5},
		{"rhs_tigr_sts_vdv",5},
		{"Exile_Bike_QuadBike_Black",5},
		{"rhsusf_m998_w_s_4dr_halftop",5},
		{"B_LSV_01_unarmed_black_F",5},
		{"O_T_LSV_02_unarmed_black_F",5},
		{"O_APC_Wheeled_02_rcws_F",5},
		{"rhsusf_m1a1aim_tuski_wd",5}
	};
	...
	*/
	...
	skill0[] = {
		{"aimingAccuracy",0.05,0.30},
		{"aimingShake",0.30,0.30},
		{"aimingSpeed",0.30,0.30},
		{"spotDistance",0.30,0.30},
		{"spotTime",0.30,0.30},
		{"courage",0.30,0.30},
		{"reloadSpeed",0.30,0.30},
		{"commanding",0.30,0.30},
		{"general",0.30,0.30}
	};
